...
@Autonomous
public class RedAutoClassBack6 extends OpMode {
    ...
    Pose launchPoseMain = new Pose(144-54.22,17.72, Math.toRadians(73));
    Pose controlPoint1 = new Pose(144-56.46,37.98,0);
    Pose pickupPose1 = new Pose (144-45.20,37.27, 0); //this is the one that changes
    Pose intakePose1 = new Pose(144-8.44, 37.27, 0);//this too


    Pose controlPoint2 = new Pose(144-58.80,58.5278,0);
    Pose pickupPose2 = new Pose (144-48.55,63.37, 0);
