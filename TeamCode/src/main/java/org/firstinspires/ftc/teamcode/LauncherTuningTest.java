...
public class LauncherTuningTest extends OpMode {
    ...
    @Override
    public void init() {
        bottom_motor = hardwareMap.get(DcMotor.class, "launcher1"); // port 2
        top_motor = hardwareMap.get(DcMotor.class, "launcher2"); // port 0
    ...
    public void loop() {
        ...
        telemetry.addData("top: ",top_power);
        telemetry.addData("bottom: ",bottom_power);
        telemetry.update();
    }
}
