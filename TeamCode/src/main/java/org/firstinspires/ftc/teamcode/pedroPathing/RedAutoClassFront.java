...
public class RedAutoClassFront extends OpMode {
    ...
    Pose startPose = new Pose(144-21.36630602782071,123.52395672333849, Math.toRadians(37)); //heading in radians
    Pose detectPose = new Pose(144-34.68712123,107.7528485, Math.toRadians(135)); //to detect apriltag, same as launchposeMain but different heading
    Pose launchPoseMain = new Pose(144-45.40340030911901,97.706336939721788, Math.toRadians(43));
    Pose controlPoint1 = new Pose(144-66.7958,83.5325,0);
    Pose pickupPose1 = new Pose (144-39.5,84.6, 0);
    Pose intake1 = new Pose(144-16, 84.6, 0);
    Pose leavePose = new Pose(144-32, 75, Math.toRadians(43));
    Pose controlPoint2 = new Pose(68.80518,58.5278,0);
    Pose pickupPose2 = new Pose (39.5,60.09273570324575, 0);
    Pose intake2 = new Pose(9.137, 60.092735, 0);
    ...
    public void buildPaths() {
        ...
        detectAT.setLinearHeadingInterpolation(Math.toRadians(37), Math.toRadians(135));

        scorePreload = new Path(new BezierCurve(detectPose, launchPoseMain));
        scorePreload.setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(43), 0.8);
        pickup1 =  new Path(new BezierCurve(launchPoseMain, controlPoint1, pickupPose1));
        pickup1.setLinearHeadingInterpolation(Math.toRadians(43),0);
        ...
        launch1.setLinearHeadingInterpolation(0, Math.toRadians(43));
        leave1 = new Path(new BezierCurve(launchPoseMain, leavePose));
        leave1.setConstantHeadingInterpolation(Math.toRadians(43));
...
//        turningthing.turnBasedOffColor(patternArray[0]);
        ...
        while (actionTimer.getElapsedTime() < 2076.7) { //fix times
