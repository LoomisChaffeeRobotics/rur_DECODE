...
public class RedAutoClassFront extends OpMode {
    ...
    Pose launchPose1 =  new Pose(144-37.39103554868624,108.16692426584235, Math.toRadians(37));
    Pose launchPoseMain = new Pose (144-45.40340030911901,97.706336939721788, -Math.PI);
    Pose controlPoint1 = new Pose(144-60.53786707882535,82.34930448222565,-Math.PI);
    Pose pickupPose1 = new Pose (144-39.5,83.68469860896445, -Math.PI);
    Pose intake1 = new Pose(144-16, 83.68469860896445, -Math.PI);
    Pose controlPoint2 = new Pose(144-50.07727975270479,54.30602782071097,-Math.PI);
    Pose pickupPose2 = new Pose (144-39.5,60.09273570324575, -Math.PI);
    Pose intake2 = new Pose(144-9.137, 60.092735, -Math.PI);
