...
//         Driving
    ...
    public void startTurret(double power){ // Done?
        ...
        launchClass.shoot(limeLightTurretSystem.getDistance_from_apriltag(!isRed) + 0.1 /*0.17 to get distance to center of turret + 0.23 to get to the center of the goal*/);
